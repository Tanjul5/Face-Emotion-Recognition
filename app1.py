...
def main():
    ...
    <h2 style="color:white;text-align:center;">Check Webcam is working or not</h2>
        ...
        st.write('''
                  ...
                  5. Still webcam window did not open,  Contact Us.''')
        app_video_filters()
    ...
    <h2 style="color:white;text-align:center;">Haar Cascade Object Detection</h2>
        ...
        st.write('''
                  Email:- tanjulgohar5@gmail.com.
                 
                  Linkedin:-https://www.linkedin.com/in/tanjul-gohar-893aa61b6/
                  
                  Email:- kanikasingh5433@gmail.com.
                  
                  https://www.linkedin.com/in/kanika-singh-602a53200
